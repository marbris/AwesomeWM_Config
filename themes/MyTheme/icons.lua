...
local icondir = theme_path .. "icons/fontawesome/png40/"
local tag_icondir = theme_path .. "icons/tags/"
...
theme.tag_icon_communication = tag_icondir .. "forum.svg"
theme.awesome_icon = tag_icondir .. "awesome-icon.png"
