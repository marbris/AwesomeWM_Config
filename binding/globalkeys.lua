...
function _M.get()
	local globalkeys = gears.table.join(
		...
		awful.key({ modkey }, "space", function()
			awful.layout.inc(1)
		end, { description = "Select Next", group = "Navigation and Layout" }),
		awful.key({ modkey, "Shift" }, "space", function()
			awful.layout.inc(-1)
		end, { description = "Select Previous", group = "Navigation and Layout" }),

		-- modkey + h-j-k-l : switch focus and position on clients.
		awful.key({ modkey }, "h", function()
			awful.client.swap.byidx(-1)
		end, { description = "Swap with Previous Client", group = "Navigation and Layout" }),
		awful.key({ modkey }, "l", function()
			awful.client.swap.byidx(1)
		end, { description = "Swap wth Next Client", group = "Navigation and Layout" }),
		awful.key({ modkey }, "k", function()
			awful.client.focus.byidx(1)
		end, { description = "Focus Next Client", group = "Navigation and Layout" }),
		awful.key({ modkey }, "j", function()
			awful.client.focus.byidx(-1)
		end, { description = "Focus Previous Client", group = "Navigation and Layout" }),

		-- modkey|Shift +  h-j-k-l to resize the windows.
		awful.key({ modkey, "Shift" }, "l", function()
			awful.tag.incmwfact(0.05)
		end, { description = "IncreaseMaster Width Factor", group = "Navigation and Layout" }),
		awful.key({ modkey, "Shift" }, "h", function()
			awful.tag.incmwfact(-0.05)
		end, { description = "Decrease Master Width Factor", group = "Navigation and Layout" }),
		awful.key({ modkey, "Shift" }, "j", function()
			awful.client.incwfact(-0.05)
		end, { description = "Decrease Master Height Factor", group = "Navigation and Layout" }),
		awful.key({ modkey, "Shift" }, "k", function()
			awful.client.incwfact(0.05)
		end, { description = "Increase Master Height Factor", group = "Navigation and Layout" }),

		-- modkey|Ctrl + h-j-k-l to reorganize the Layout
		awful.key({ modkey, "Control" }, "h", function()
			awful.tag.incnmaster(1, nil, true)
		end, { description = "Increase the Number of master Clients", group = "Navigation and Layout" }),
		awful.key({ modkey, "Control" }, "l", function()
			awful.tag.incnmaster(-1, nil, true)
		end, { description = "Decrease the Number of master Clients", group = "Navigation and Layout" }),
		awful.key({ modkey, "Control" }, "k", function()
			awful.tag.incncol(1, nil, true)
		end, { description = "Increase the Cumber of Columns", group = "Navigation and Layout" }),
		awful.key({ modkey, "Control" }, "j", function()
			awful.tag.incncol(-1, nil, true)
		end, { description = "Decrease the Number of Columns", group = "Navigation and Layout" }),

		-- Monitor navigation
		awful.key({ modkey, "Shift" }, "g", function()
			awful.screen.focus_relative(1)
		end, { description = "Toggle Screen", group = "Navigation and Layout" }),
		...
		end, { description = "VScodium", group = "Applications" }),

		-- awful.key({ modkey },            "r",     function () awful.spawn("bash ~/.config/rofi/launchers/type-4/launcher.sh") end,
		-- {description = "run rofi", group = "launcher"}),
		awful.key({ modkey }, "a", function()
			awful.spawn(launchmenu)
		end, { description = "Launch Menu", group = "Applications" }),
		...
		awful.key({ modkey, "Shift" }, "Delete", function()
			awful.spawn("reboot")
		end, { description = "Reboot Computer", group = "Utilities" }),

		awful.key({ modkey, "Control" }, "Delete", function()
			awful.spawn("shutdown now")
		end, { description = "Shutdown Computer", group = "Utilities" }),

		awful.key({ modkey }, "F2", awesome.restart, { description = "Reload Awesome", group = "Utilities" }),

		awful.key({ modkey }, "End", awesome.quit, { description = "Quit Awesome", group = "Utilities" }),

		awful.key({ modkey }, "F1", hotkeys_popup.show_help, { description = "Show Help", group = "Utilities" }),

		awful.key({ modkey }, "F7", function()
			awful.spawn("bash /home/martin/.screenlayout/Layout_at_Work.sh")
		end, { description = "Run Xrandr Monitor Script", group = "Utilities" }),

		awful.key({ "Shift" }, "Print", function()
			awful.spawn.with_shell(screenshot)
		end, { description = "Screenshot", group = "Utilities" }),
		awful.key({}, "Print", function()
			awful.spawn.with_shell(region_screenshot)
		end, { description = "Region Screenshot", group = "Utilities" }),

		awful.key({ modkey, "Shift" }, "F12", function()
			awful.spawn("nm-applet")
		end, { description = "nm-applet", group = "Utilities" }),
		...
		awful.key({}, "XF86MonBrightnessDown", function()
			awful.util.spawn("xbacklight -dec 15 -steps 1")
		end),
		awful.key({}, "XF86MonBrightnessUp", function()
			awful.util.spawn("xbacklight -inc 15 -steps 1")
		end),
		...
		end, { description = "Increase Height", group = "Client: Floating" }),
		awful.key({ modkey, "Control" }, "Down", function()
			awful.client.moveresize(0, 0, 0, 20)
		end, { description = "Decrease Height", group = "Client: Floating" }),
		awful.key({ modkey, "Control" }, "Left", function()
			awful.client.moveresize(0, 0, -20, 0)
		end, { description = "Decrease Width", group = "Client: Floating" }),
		awful.key({ modkey, "Control" }, "Right", function()
			awful.client.moveresize(0, 0, 20, 0)
		end, { description = "Increase Width", group = "Client: Floating" }),

		-- Move
		awful.key({ modkey, "Shift" }, "Down", function()
			awful.client.moveresize(0, 20, 0, 0)
		end, { description = "Move Down", group = "Client: Floating" }),
		awful.key({ modkey, "Shift" }, "Up", function()
			awful.client.moveresize(0, -20, 0, 0)
		end, { description = "Move Up", group = "Client: Floating" }),
		awful.key({ modkey, "Shift" }, "Left", function()
			awful.client.moveresize(-20, 0, 0, 0)
		end, { description = "Move Left", group = "Client: Floating" }),
		awful.key({ modkey, "Shift" }, "Right", function()
			awful.client.moveresize(20, 0, 0, 0)
		end, { description = "Move Right", group = "Client: Floating" })
