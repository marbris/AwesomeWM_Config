...
local globalKeys =
  ...
  awful.key({modkey, }, 'e', function() awful.util.spawn(apps.default.files) end,
  ...
  awful.key({modkey, }, '2', function() awful.util.spawn(apps.default.email) end,
  ...
  --awful.key({modkey, }, 'Print', function() awful.util.spawn_with_shell(apps.default.delayed_screenshot) end,
  ...
  awful.key({modkey, }, 'End', function() awful.spawn(apps.default.lock) end,
